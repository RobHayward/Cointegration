...
The main idea of cointegration is that a combnation of one or more non-stationary variables will show a stationary relationship.  One way to look at this is to use the \emph{Engle-Granger} method. For an example of this, create two non-stationary series $(y1)$ and $(y2)$ with a long-run relationship  
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlfunctioncall{set.seed}(123456)
